...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
          package='rviz2',
          executable='rviz2',
          arguments=['-d','./src/chibi25_b/local_path_planner/launch/teamb_rviz_debag.rviz'],
        ),
        ExecuteProcess(
          cmd=['ros2', 'bag', 'play', '/home/user/ws/src/chibi25_b/bag','--clock'],
          output='screen'
        ),
        ...
        LifecycleNode(
            ...
            output='screen',
            parameters=[{
                'yaml_filename': '/home/user/ws/src/chibi25_b/map/b_map_fixed.yaml'
            }]
        ),
